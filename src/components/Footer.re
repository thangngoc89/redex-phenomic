    ...
    <div className=(Styles.root(context))>
      <div className=CommonStyles.widthContainer>
        <section>
          ...
          <ul>
            <li>
              <a href="https://github.com/redex/redex.github.io">
                ("Source Code Repository" |> text)
              </a>
            </li>
            <li>
              <a href="https://github.com/redex/redex.github.io/issues">
                ("Support / Bug Tracker" |> text)
              </a>
            </li>
            <li> <Link href="/publish"> ("Get Published" |> text) </Link> </li>
          </ul>
        </section>
        <section>
          ...
          <ul>
            ...
            <li>
              <a href="https://www.gatsbyjs.org/"> ("Gatsby" |> text) </a>
            </li>
            <li>
          ...
          <ul>
            <li>
              <a href="https://reasonml.github.io/">
                ("Reason Homepage" |> text)
              </a>
            </li>
            <li>
              <a href="https://reasonml.github.io/guide">
                ("Reason Guide" |> text)
              </a>
            </li>
            <li>
              <a href="https://reasonml.github.io/try">
                ("Reason Playground" |> text)
              </a>
            </li>
          </ul>
        </section>
